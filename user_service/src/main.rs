...
fn rocket() -> _ {
    ...
    let rocket_instance = rocket::custom(config)
        ...
        .mount("/user", routes![user_routes::post_user, user_routes::get_user_by_id, user_routes::delete_user, user_routes::login, user_routes::follow_user, user_routes::get_pfp]);
